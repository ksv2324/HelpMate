...
interface RequestFormProps {
  onClose: () => void;
  onSubmit?: (data: { title: string; requesterName: string; description: string; location: string }) => void;
}
  ...
  return (
    <div className="h-full bg-white flex flex-col">
      ...
      <div className="px-4 py-4 border-b border-gray-200 flex items-center justify-between">
        <h2 className="text-gray-900">{t.addRequest}</h2>
        <button
          onClick={onClose}
      ...
      <div className="flex-1 overflow-auto px-4 py-4">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="title"
              placeholder="e.g., Rice & Groceries, Warm Blankets"
              value={values.title}
          ...
          <div className="space-y-2">
            <Label htmlFor="requester-name">{t.name} (Optional)</Label>
            <Input
              id="requester-name"
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-4">
            <p className="text-gray-700">
              <strong>Note:</strong> Nearby donors will be able to see your request and contact you to help.
            </p>
          </div>
        </div>
      </div>
